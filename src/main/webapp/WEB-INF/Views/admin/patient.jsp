...
<div class="main-content app-content mt-0"  ng-controller="patientctrl">
<div class="side-app">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                        ...
                        <tbody>
                                ...
                                <tr ng-repeat="data in patientdata">
                                    ...
                                    <td>{{data.name}}</td>
                                    <td class="d-flex">
                                        <a href="" class='btn btn-primary shadow btn-sm  me-3 ml-2' title='Edit'>
                                            <i class='fa fa-pencil'></i>
                                        </a>
                                        <form action="" method="POST">
                                            
                                            <button class='btn btn-danger shadow btn-sm  me-3 ml-2'>
