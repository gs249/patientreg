...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath()%>/resources/images/brand/favicon.ico" />
...
<body class="app sidebar-mini ltr login-img">
            ...
            <div class="">
              ...
              <!--  <div class="col col-login mx-auto mt-7">
                    <div class="text-center">
                        <a href="index.html"><img src="<%=request.getContextPath()%>/resources/images/brand/logo-white.png" class="header-brand-img" alt=""></a>
                    </div>
                </div>-->
    ...
    <!-- BOOTSTRAP JS -->
    <script src="<%=request.getContextPath()%>/resources/plugins/bootstrap/js/popper.min.js"></script>
    <script src="<%=request.getContextPath()%>/resources/plugins/bootstrap/js/bootstrap.min.js"></script>

    <!-- SHOW PASSWORD JS -->
    <script src="<%=request.getContextPath()%>/resources/js/show-password.min.js"></script>

    <!-- GENERATE OTP JS -->
    <script src="<%=request.getContextPath()%>/resources/js/generate-otp.js"></script>

    <!-- Perfect SCROLLBAR JS-->
    <script src="<%=request.getContextPath()%>/resources/plugins/p-scroll/perfect-scrollbar.js"></script>

    <!-- Color Theme js -->
    <script src="<%=request.getContextPath()%>/resources/js/themeColors.js"></script>
